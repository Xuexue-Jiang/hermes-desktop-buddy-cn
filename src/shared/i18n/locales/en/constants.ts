export default {
  ...
  deepseekDesc: "China-friendly reasoning and coding models",
  qwenName: "Qwen / DashScope",
  qwenDesc: "Alibaba Cloud Qwen models",
  kimiName: "Kimi / Moonshot",
  kimiDesc: "Moonshot AI long-context models",
  zaiName: "Z.ai / GLM",
  zaiDesc: "ZhipuAI GLM models",
  minimaxCnName: "MiniMax China",
  minimaxCnDesc: "MiniMax China endpoint",
  minimaxName: "MiniMax",
  chinaFirstTag: "China-first",
