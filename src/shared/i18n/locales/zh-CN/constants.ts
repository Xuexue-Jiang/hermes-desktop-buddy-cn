export default {
  ...
  deepseekDesc: "中国大陆访问友好的推理与编程模型",
  qwenName: "通义千问 / DashScope",
  qwenDesc: "阿里云百炼的 Qwen 模型",
  kimiName: "Kimi / 月之暗面",
  kimiDesc: "月之暗面的长上下文模型",
  zaiName: "智谱 GLM / Z.ai",
  zaiDesc: "智谱 AI GLM 模型",
  minimaxCnName: "MiniMax 中国",
  minimaxCnDesc: "MiniMax 中国节点",
  minimaxName: "MiniMax",
  chinaFirstTag: "中国优先",
