...
export const PROVIDERS = {
  ...
  options: [
    ...
    { value: "zai", label: "constants.zaiName" },
    { value: "qwen", label: "constants.qwenName" },
    { value: "minimax", label: "constants.minimaxName" },
    { value: "kimi", label: "constants.kimiName" },
  ...
  labels: {
    ...
    mistral: "Mistral",
    deepseek: "constants.deepseekName",
    groq: "Groq",
    ...
    nvidia: "NVIDIA NIM",
    zai: "constants.zaiName",
    qwen: "constants.qwenName",
    minimax: "constants.minimaxName",
    kimi: "constants.kimiName",
    ...
    custom: "constants.customOpenAICompatibleName",
  ...
  setup: [
    ...
    {
      id: "zai",
      name: "constants.zaiName",
      desc: "constants.zaiDesc",
      tag: "constants.chinaFirstTag",
      envKey: "GLM_API_KEY",
    ...
    {
      id: "minimax-cn",
      name: "constants.minimaxCnName",
      desc: "constants.minimaxCnDesc",
      tag: "constants.chinaFirstTag",
